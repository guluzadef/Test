...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        if os.path.exists(venv_path):
            subprocess.call("rm -rf $(pwd)/default/templates/* && cp -r {}/lib/python{}/site-packages/oscar/templates/oscar/* $(pwd)/default/templates && cd default/templates && tree".format(venv_path, PYTHON_VERSION),shell=True)
